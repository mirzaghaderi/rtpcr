...
- Introduced a unified input data structure for all expression analysis functions.
...
- Added publication-ready graphical outputs via the `plotFacto()` function for one- to three-factor experimental designs.
