...
#' @import lme4
#' @import agricolae
#' @param x the ouptput object created by \link{qpcrANOVA} function via running \code{res <- qpcrANOVA(x)} on a three factorial data such as \code{data_3factor} example data frame.
