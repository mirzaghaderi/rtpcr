...
For `TTEST_DDCt` and `WILCOX_DDCt` (independent samples), `ANOVA_DCt`, and `ANOVA_DDCt` each row is from a
...
![](man/figures/standCur.png){.center width="67%"}
