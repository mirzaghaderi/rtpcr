...
[general calculation
method](https://mirzaghaderi.github.io/rtpcr/inst/method.md) described
by Ganger et al. (2017) and Taylor et al. (2019) for covering both the
Livak and Pfaffl methods.

- [Improvement in the current GitHub version
  `rtpcr_v2.1.1`](#improvement-in-the-current-github-version-rtpcr_v211)
- [Functions](#functions)
...
The current version of the `rtpcr` package can be installed from GitHub
