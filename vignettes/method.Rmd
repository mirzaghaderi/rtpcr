...
$$
and for more than one reference gene, the log2.Ct term of the references, and the whole wDCt  is defined using the geometric mean as follow:
...
\right)^{1/n}
$$
where the geometric mean of the efficieny values of the referene genes is:
