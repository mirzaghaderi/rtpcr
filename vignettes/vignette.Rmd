...
NOTE: For ANOVA and ANCOVA analysis, each line in the input data set should belong to a separate individual reflecting a non-repeated measure experiment).
