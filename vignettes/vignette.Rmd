...
# I strongly recommend to install the package with the vignette as it contains information about how to use 'rtpcr' package. Through the following code, Vignette is installed as well.
