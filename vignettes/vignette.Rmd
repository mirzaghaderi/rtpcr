...
| function   |                 Analysis | Example (see package help for the more arguments) |
 ...
 | qrtpcrANCOVA      | FC and bar plot of the target gene (one or multi-factorial experiments) | qpcrANCOVA(data_1factor, numberOfrefGenes = 1, analysisType = "ancova", main.factor = 1) |
