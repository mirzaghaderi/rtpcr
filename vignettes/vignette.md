...
##   contrast     FC pvalue sig       LCL      UCL    sddiff        se
## 1       D0      1 1.0000     0.4712356 2.122081 0.3704538 0.3444803
## 2 D1 vs D0 1.0705 0.8051     0.5446459 2.104206 0.3466862 0.2630895
## 3 D2 vs D0 3.5967 0.0003 *** 1.6702550 7.744999 1.3629288 0.3576280
## 
...
## 1                  Control      1 1.0000     0.9449197 1.058291 0.02041662
## 2 Treatment_1\nvs\nControl 2.1987 0.0208   * 0.5965179 8.104347 0.87621698
## 3 Treatment_2\nvs\nControl 3.4661 0.0027  ** 2.7448323 4.377019 0.21011548
##           se
## 1 0.02081666
## 2 0.43879887
## 3 0.08412953
...
## 1     R    L A1   1       2    33.30    2 31.53  1.77
## 2     R    L A1   2       2    33.39    2 31.57  1.82
## 3     R    L A1   3       2    33.34    2 31.50  1.84
## 4     R    L A2   1       2    34.01    2 31.48  2.53
## 5     R    L A2   2       2    36.82    2 31.44  5.38
## 6     R    L A2   3       2    35.44    2 31.46  3.98
## 7     R    M A1   1       2    32.73    2 31.30  1.43
## 8     R    M A1   2       2    32.46    2 32.55 -0.09
## 9     R    M A1   3       2    32.60    2 31.92  0.68
## 10    R    M A2   1       2    33.37    2 31.19  2.18
## 11    R    M A2   2       2    33.12    2 31.94  1.18
## 12    R    M A2   3       2    33.21    2 31.57  1.64
## 13    R    H A1   1       2    33.48    2 33.30  0.18
## 14    R    H A1   2       2    33.27    2 33.37 -0.10
## 15    R    H A1   3       2    33.32    2 33.35 -0.03
## 16    R    H A2   1       2    32.53    2 33.47 -0.94
## 17    R    H A2   2       2    32.61    2 33.26 -0.65
## 18    R    H A2   3       2    32.56    2 33.36 -0.80
## 19    S    L A1   1       2    26.85    2 26.94 -0.09
## 20    S    L A1   2       2    28.17    2 27.69  0.48
## 21    S    L A1   3       2    27.99    2 27.39  0.60
## 22    S    L A2   1       2    28.71    2 29.45 -0.74
## 23    S    L A2   2       2    29.01    2 29.46 -0.45
## 24    S    L A2   3       2    28.82    2 29.48 -0.66
## 25    S    M A1   1       2    30.41    2 28.70  1.71
## 26    S    M A1   2       2    29.49    2 28.66  0.83
## 27    S    M A1   3       2    29.98    2 28.71  1.27
## 28    S    M A2   1       2    28.91    2 28.09  0.82
## 29    S    M A2   2       2    28.60    2 28.65 -0.05
## 30    S    M A2   3       2    28.59    2 28.37  0.22
## 31    S    H A1   1       2    29.03    2 30.61 -1.58
## 32    S    H A1   2       2    28.73    2 30.20 -1.47
## 33    S    H A1   3       2    28.83    2 30.49 -1.66
## 34    S    H A2   1       2    28.29    2 30.84 -2.55
## 35    S    H A2   2       2    28.53    2 30.65 -2.12
## 36    S    H A2   3       2    28.28    2 30.74 -2.46
## 
## $lmCRD
## 
## Call:
...
##     0.01667     -0.81333      1.79333      3.94667      0.65667      1.65000  
##     TS:H:A1      TS:H:A2      TS:L:A1      TS:L:A2      TS:M:A1      TS:M:A2  
##    -1.58667     -2.39333      0.31333     -0.63333      1.25333      0.31333  
## 
## 
## $ANOVA
## Analysis of Variance Table
...
<img src="vignette_files/figure-html/unnamed-chunk-14-1.png" style="display: block; margin: auto;" />
