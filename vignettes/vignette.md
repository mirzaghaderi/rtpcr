...
*Table 3. Functions and examples for using them.*
 ...
 | twoFACTORplot   | Bar plot of the relative gene expression from a two-factor experiment | res <- qpcrANOVA(data_2factor, numberOfrefGenes = 1)\$Result; twoFACTORplot(res, x.axis.factor = Genotype, group.factor = Drought) |
  | qpcrREPEATED   | Bar plot of the fold change expression for repeated measure data (where you take observations repeatedly over time) |  qpcrREPEATED(data_repeated_measure_2, numberOfrefGenes = 1 |
...
## 1       D0         1 1.0000000000     0.0000000 0.000000 0.3444803
## 2 D1 vs D0  1.070536 0.8051169743     0.5266149 2.176253 0.2630895
## 3 D2 vs D0 3.5966821 0.0003271647 *** 1.7692690 7.311563 0.3576280
## 
...
## 1                  Control         1 1.000000000     0.000000 0.000000
## 2 Treatment_1\nvs\nControl 2.1987242 0.020783641   * 1.011247 4.780620
## 3 Treatment_2\nvs\nControl 3.4661482 0.002682167  ** 1.594167 7.536342
##           se
## 1 0.02081666
## 2 0.43879887
## 3 0.08412953
...
## c("#778899", : The level 1 was used as calibrator.
```
...
## "time", : The level 1 was used as calibrator.
```
...
## $FC_statistics_of_the_main_factor
##         contrast        FC     pvalue sig       LCL       UCL        se
## 1           time         1 1.00000000     0.0000000  0.000000 1.4050662
## 2 time2 vs time1  0.856584 0.81660352     0.0923034  7.949179 0.9752663
## 3 time3 vs time1 4.7021916 0.06847307   . 0.5066967 43.636771 0.5541059
## 
## $FC_Plot
## 
## $Final_data
##    id treatment time Etarget Cttarget Eref Ctref   wDCt
## 1   1   treated    1       2    18.92    2 32.77 -13.85
## 2   1   treated    2       2    19.46    2 33.03 -13.57
## 3   1   treated    3       2    15.73    2 32.95 -17.22
## 4   2   treated    1       2    15.82    2 32.45 -16.63
## 5   2   treated    2       2    17.56    2 33.24 -15.68
## 6   2   treated    3       2    17.21    2 33.64 -16.43
## 7   3   treated    1       2    19.84    2 31.62 -11.78
## 8   3   treated    2       2    19.74    2 32.08 -12.34
## 9   3   treated    3       2    18.09    2 33.40 -15.31
## 10  4 untreated    1       2    19.24    2 33.73 -14.49
## 11  4 untreated    2       2    19.95    2 34.20 -14.25
## 12  4 untreated    3       2    19.16    2 33.90 -14.74
## 13  5 untreated    1       2    20.11    2 32.56 -12.45
## 14  5 untreated    2       2    20.91    2 33.98 -13.07
## 15  5 untreated    3       2    20.91    2 33.16 -12.25
## 16  6 untreated    1       2    20.63    2 33.72 -13.09
## 17  6 untreated    2       2    19.16    2 34.51 -15.35
## 18  6 untreated    3       2    19.91    2 34.33 -14.42
## 
## $lm
## Linear mixed model fit by REML ['lmerModLmerTest']
## Formula: formula
...
##              (Intercept)                     time2                     time3  
##                 -14.0867                    0.2233                   -2.2333  
##       treatmentuntreated  time2:treatmentuntreated  time3:treatmentuntreated  
...
## $FC_statistics_of_the_main_factor
##         contrast        FC   pvalue sig       LCL      UCL        se
## 1           time         1 1.000000     0.0000000 0.000000 0.7035896
## 2 time2 vs time1 1.2555621 0.554023     0.4380531 3.598733 0.5323387
## 3 time3 vs time1 2.5432383 0.035091   * 0.8873106 7.289512 0.7074151
## 
## $FC_Plot
```
