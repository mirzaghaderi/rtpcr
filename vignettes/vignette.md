...
| function   |                 Analysis | Example (see package help for the more arguments) |
 ...
 | qrtpcrANCOVA      | FC and bar plot of the target gene (one or multi-factorial experiments) | qpcrANCOVA(data_1factor, numberOfrefGenes = 1, analysisType = "ancova", main.factor = 1, levels = c(1, 2, 3)) |
...
## 2 - 3 0.2976 0.0005     *** 0.1664 0.5323
## 
## $plot
```
...
## 
## $Final_data
##   condition rep Etarget Cttarget Eref Ctref       wDCt
## 1         3   1       2    33.30    2 31.53  0.5328231
## 2         3   2       2    33.39    2 31.57  0.5478746
## 3         3   3       2    33.34    2 31.50  0.5538952
## 4         2   1       2    32.73    2 31.30  0.4304729
## 5         2   2       2    32.46    2 32.55 -0.0270927
## 6         2   3       2    32.60    2 31.92  0.2047004
## 7         1   1       2    33.48    2 33.30  0.0541854
## 8         1   2       2    33.27    2 33.37 -0.0301030
## 9         1   3       2    33.32    2 33.35 -0.0090309
## 
## $lmf
## 
## Call:
...
## 
## Coefficients:
##           (Intercept)  as.factor(condition)2  as.factor(condition)3  
##              0.005017               0.197676               0.539847  
## 
## 
## $lmc
## 
...
## Response: wDCt
##                      Df  Sum Sq  Mean Sq F value   Pr(>F)   
## as.factor(condition)  2 0.44759 0.223796  12.345 0.007473 **
...
## $Table
##           FC pvalue signif.    LCL    UCL
## 1 - 2 1.5764 0.1223         0.8485 2.9287
## 1 - 3 3.4661 0.0027      ** 1.8657 6.4395
## 2 - 3 2.1987 0.0208       * 1.1835 4.0848
## 
## $plot
```
