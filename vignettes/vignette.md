...
| function   |                 Analysis | Example (see package help for the more arguments) |
 ...
 | qpcrANCOVA      | FC and bar plot of the target gene (one or multi-factorial experiments) | qpcrANCOVA(data_1factor, numberOfrefGenes = 1, main.factor.column = 1, mainFactor.level.order = c("L1", "L2", "L3") |
...
```
## $Final_data
##    Drought Genotype rep Etarget Cttarget Eref Ctref       wDCt       resid
## 1        0        R   1       2    33.30    2 31.53  0.5328231  0.08679698
## 2        0        R   2       2    33.39    2 31.57  0.5478746  0.10184848
## 3        0        R   3       2    33.34    2 31.50  0.5538952  0.10786908
## 10       0        S   1       2    26.85    2 26.94 -0.0270927 -0.22527078
## 11       0        S   2       2    28.17    2 27.69  0.1444944 -0.05368368
## 12       0        S   3       2    27.99    2 27.39  0.1806180 -0.01756008
## 4     0.25        R   1       2    32.73    2 31.30  0.4304729  0.01404807
## 5     0.25        R   2       2    32.46    2 32.55 -0.0270927 -0.44351753
## 6     0.25        R   3       2    32.60    2 31.92  0.2047004 -0.21172443
## 13    0.25        S   1       2    30.41    2 28.70  0.5147613  0.34618450
## 14    0.25        S   2       2    29.49    2 28.66  0.2498549  0.08127810
## 15    0.25        S   3       2    29.98    2 28.71  0.3823081  0.21373130
## 7      0.5        R   1       2    33.48    2 33.30  0.0541854  0.16406135
## 8      0.5        R   2       2    33.27    2 33.37 -0.0301030  0.07977295
## 9      0.5        R   3       2    33.32    2 33.35 -0.0090309  0.10084505
## 16     0.5        S   1       2    29.03    2 30.61 -0.4756274 -0.11790341
## 17     0.5        S   2       2    28.73    2 30.20 -0.4425141 -0.08479012
## 18     0.5        S   3       2    28.83    2 30.49 -0.4997098 -0.14198581
## 
## $lm_ANOVA
## 
## Call:
...
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## $`Fold change statistics for the main factor:`
##                 contrast               FC        sd       pvalue sig
## 1                      0                1 0.2540094 1.0000000000    
## 2 Drought0 - Drought0.25 1.07053601619469 0.5942883 0.9658293646  ns
## 3  Drought0 - Drought0.5 3.59668214255274 0.5509318 0.0008935822 ***
## 
